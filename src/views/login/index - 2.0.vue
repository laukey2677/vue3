<template>
	<div class="login">
		<div class="login-wrap">
			<ul class="ul">
				<li :class="['li',{'active':item.id == mode}]" v-for="(item) in menuList" :key="item.id" @click="mode = item.id">{{ item.text }}</li>
			</ul>
...
<script>
import { stripscript, validateEmail, validatePwd, validateVcode } from '@/utils/validate.js';
